...
| P02 — Security boundaries         | Verification  | Contact intake, safe rich content, managed media, durable admin sessions, production TOTP/recovery, and guarded MFA reset are implemented; the replica-set integration suite passes                                        | End-to-end abuse/session/media acceptance                                             |
...
| P12 — Generated media             | Partial       | The 17-master Architected Intelligence manifest, prompt grammar, negative constraints, provenance template, truthful pending intents, seed/media binding prerequisites, and five hero candidates are committed as evidence | Approve, ingest, attach, and verify the managed media set                             |
...
| P14 — Homepage                    | Partial       | Server Page composition, sticky five-pillar narrative, architecture/AI workflow story, process, and several dynamic evidence sections are implemented                                                                      | Complete linked proof, case-study strength, trust rhythm, and browser acceptance      |
...
| P17 — About/contact/legal         | Partial       | Contact and legal flows are dynamic and hardened; About consumes published Page/Site data; all seven fixed routes now share the secure public-renderer preview pipeline                                                    | Complete the deeper About narrative and final authenticated browser acceptance        |
