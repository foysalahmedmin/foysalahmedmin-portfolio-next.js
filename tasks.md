...
| P12   | Partial      | `ba98f68` commits the 17-master direction, prompt/provenance contract, resolved seed/media binding prerequisites, and truthful remaining blockers; no asset is claimed generated | Generate and approve the System Design pilot, then ingest/attach managed media                                            |
...
- [ ] Generate Frontend hero master and mobile-aware crop.
- [ ] Generate Backend hero master and mobile-aware crop.
- [ ] Generate AI Automation hero master and mobile-aware crop.
- [ ] Generate System Design hero master and mobile-aware crop.
- [ ] Generate Full-Stack hero master and mobile-aware crop.
...
2. Complete **P12** generated non-human media through the shared managed-media path, next generating and approving the System Design pilot before any batch generation.
