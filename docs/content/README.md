...
- `generated-media-evidence/system-design-pilot.v1.json` records the generated System Design pilot candidate, tracked asset paths, checksums, and pending approval gates; it is not publication approval.
- `generated-media-evidence/hero-candidates.v1.json` records the five generated hero candidates, tracked seed/public asset paths, checksums, optimization evidence, and remaining approval/ingestion gates.
