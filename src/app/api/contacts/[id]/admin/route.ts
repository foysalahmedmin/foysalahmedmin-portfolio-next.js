  ...
  try {
    ...
    return await auth('super-admin', 'admin' as TRole)(
      ...
      (authedReq) => {
        ...
        return ContactController.getContactById(authedReq, { params: resolvedParams });
      },
    );
  } catch (error) {
    ...
    return await auth('super-admin', 'admin' as TRole)(
      ...
      async (authedReq) => {
        ...
        return await validation(ContactValidation.updateContactByIdSchema)(
          authedReq,
          (validatedReq) =>
            ContactController.updateContactById(validatedReq, { params: resolvedParams }),
        );
      },
    );
  } catch (error) {
    ...
    return await auth('super-admin', 'admin' as TRole)(
      ...
      async (authedReq) => {
        ...
        return await validation(ContactValidation.contactByIdOperationValidationSchema)(
          authedReq,
          (validatedReq) =>
            ContactController.deleteContactById(validatedReq, { params: resolvedParams }),
        );
      },
    );
  } catch (error) {
