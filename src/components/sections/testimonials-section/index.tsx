...
const testimonials: Testimonial[] = [
  {
    ...
    content: "Working with Foysal was a game-changer for our project. His expertise in Node.js and attention to detail ensured a smooth and high-performance backend architecture.",
  },
  {
    name: "Sarah Miller",
    role: "Product Manager",
    content: "Minimalist, efficient, and professional. Foysal delivered exactly what we needed within the deadline. Highly recommended for full-stack development.",
  },
  {
    name: "Michael Chen",
    role: "Full Stack Developer",
    content: "I've collaborated with many developers, but Foysal's commitment to clean code and conventional naming is outstanding. A true professional.",
  },
];
