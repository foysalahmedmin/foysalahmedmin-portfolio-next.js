...
const ArticleForm: React.FC<ArticleFormProps> = ({ initialData, onSubmit, onCancel, loading }) => {
    const [formData, setFormData] = useState<Partial<TArticle>>(initialData || {
        name: "",
        slug: "",
        description: "",
        content: "",
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Excerpt / Summary</label>
                <textarea 
                    name="description"
            ...
            <div className="space-y-2">
                <label className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Body Content (Markdown/HTML)</label>
                <textarea 
                    name="content"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="flex items-center gap-3 pt-8">
                    ...
                    />
                    <label htmlFor="is_featured" className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Featured Article</label>
                </div>
            </div>
            ...
            <div className="flex justify-end gap-4 pt-6">
                ...
                <Button type="submit" className="gap-2" isLoading={loading}>
                    <Save className="size-4" /> {initialData ? "Update Article" : "Create Article"}
                </Button>
            </div>
        </form>
    );
